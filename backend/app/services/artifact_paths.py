...
_DRY_RUN_RECORD_ARTIFACTS = [
    {
        "name": "run_manifest.json",
        "artifact_type": "dry_run_manifest",
        "description": "Generated dry-run manifest for the placeholder execution contract.",
    },
    {
        "name": "execution_summary.json",
        "artifact_type": "dry_run_execution_summary",
        "description": (
            "Generated dry-run execution summary. "
            "No real RNA-seq execution was performed."
        ),
    },
    {
        "name": "planned_steps.json",
        "artifact_type": "dry_run_planned_steps",
        "description": (
            "Generated list of future workflow steps that were planned but not executed."
        ),
    },
]
...
def list_dry_run_record_specs(task_id: str) -> list[dict]:
    specs: list[dict] = []
    for artifact in _DRY_RUN_RECORD_ARTIFACTS:
        filename = artifact["name"]
        specs.append(
            {
                "name": filename,
